...
if __name__ == '__main__':
    ...
    if not os.path.exists(os.path.join(args.model_dir, args.model_name)):
        ...
        model = torch.load(os.path.join(args.model_dir, './temp1.pkl'))
...
#    model.train()
    ...
    for set_cur in args.set_names:
        ...
        for im in os.listdir(os.path.join(args.set_dir, set_cur)):
            if im.endswith(".jpg") or im.endswith(".bmp") or im.endswith(".png"):
                ...
                if args.save_result:
                    ...
                    temp_results = save_result(x_, path=os.path.join(
        ...
        print("*****Test metrics*****")
        logger.info(temp_results)

        psnrs.append(psnr_avg)
        ssims.append(ssim_avg)
        logger.warning()
        print("***** Running predition *****")
        if args.save_result:
        ...
        print("*****Predict results (*****Four pillars,Team No:6")
